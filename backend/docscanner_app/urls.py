...
from .ilgalaikis_turtas.views import (
    ...
    FixedAssetListView,
    FixedAssetGroupDetailView,
    FixedAssetManualCreateView,
    FixedAssetImprovementListCreateView,
    FixedAssetImprovementCancelView,
    FixedAssetSaleCandidatesView,
    FixedAssetPurchaseUsageView,
    FixedAssetPurchaseSourceView,
    FixedAssetFromPurchaseView,
    FixedAssetDetailView,
    FixedAssetOperationsView,
...
urlpatterns = [
    ...
    *router.urls,
    ...
    path("fixed-assets/groups/<int:pk>/", FixedAssetGroupDetailView.as_view()),
    path("fixed-assets/manual/", FixedAssetManualCreateView.as_view()),
    path("fixed-assets/improvements/", FixedAssetImprovementListCreateView.as_view()),
    path("fixed-assets/improvements/<int:op_id>/cancel/", FixedAssetImprovementCancelView.as_view()),
    path("fixed-assets/sale-candidates/", FixedAssetSaleCandidatesView.as_view()),
    path("fixed-assets/purchase-usage/", FixedAssetPurchaseUsageView.as_view()),
    ...
    path("fixed-assets/<int:pk>/operations/", FixedAssetOperationsView.as_view()),
