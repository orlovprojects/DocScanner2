...
#                 if logger:
#                     logger.info(
#                         "[ENHANCED-OCR] Sending %s (%d bytes, mime=%s) to %s (thinking_budget=1024)",
...
#                     if logger:
#                         logger.info(
#                             "[ENHANCED-OCR] ✓ Model=%s, thinking=%s, thinking_len=%d, result_len=%d, file=%s",
#                             model,
#                             "YES" if thinking_text else "NO",
