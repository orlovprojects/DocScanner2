...
REF_SUCCESS_WEIGHT = 60
REF_DUPLICATE_WEIGHT = 15
REF_ERROR_400_WEIGHT = 15
REF_ERROR_401_WEIGHT = 5
REF_ERROR_500_WEIGHT = 5

# Веса для ДОКУМЕНТОВ (I06_FULL)
DOC_SUCCESS_WEIGHT = 65
DOC_PARTIAL_207_WEIGHT = 10
DOC_ERROR_400_WEIGHT = 15
DOC_ERROR_401_WEIGHT = 5
DOC_ERROR_500_WEIGHT = 5
