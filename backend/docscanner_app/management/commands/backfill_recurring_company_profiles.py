...
from docscanner_app.models import RecurringInvoice, CompanyProfile, CustomUser


class Command(BaseCommand):
    help = "Backfill RecurringInvoice.company_profile for existing rows (NULL only)."
    ...
    def handle(self, *args, **opts):
        ...
        for user in CustomUser.objects.all():
            null_qs = RecurringInvoice.objects.filter(
