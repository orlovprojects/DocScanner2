...
const Pragma = () => {
  ...
  return (
    <Box sx={{ bgcolor: '#F9F9FA', minHeight: '100vh', padding: { xs: 2, sm: 5 }, paddingTop: { xs: '50px', sm: '70px' }, width: '100%' }}>
      <Helmet>
        <title>Sąskaitų importas į Pragmą</title>
        <meta name="description" content="Automatizuokite sąskaitų faktūrų įvedimą į Pragma 3,2 ir Pragma 4 buhalterines programas. DokSkenas atpažįsta dokumentus ir eksportuoja .txt bei .xml failus, paruoštus Pragma importui." />
      </Helmet>
      ...
      >
        ...
        >
          Automatizuokite sąskaitų faktūrų nuskaitymą ir įvedimą į Pragma 3,2 arba Pragma 4 bei išvenkite nuobodaus rankinio darbo ir klaidų apskaitoje.
        </Typography>
        <Typography
          variant="body1"
          sx={{
        ...
        >
          DokSkenas atpažįsta dokumentus ir paruošia .txt failus Pragma 3,2 bei .xml failus Pragma 4 importui.
        </Typography>
        <Button
          variant="contained"
          size="large"
      ...
      >
        ...
        >
          Šiame video parodome pilną procesą nuo sąskaitų įkėlimo skaitmenizuoti iki duomenų importo į Pragma 3,2.
        </Typography>
        ...
        >
          <Typography sx={{ color: '#666', fontFamily: 'Helvetica', fontSize: '18px' }}>
            Video bus įkeltas vėliau
          </Typography>
        </Box>

        {/* Предупреждение Pragma 3,2 */}
        <Box
          sx={{
            maxWidth: '800px',
            width: '100%',
        ...
        >
          ...
          >
            Jei jūsų Pragma 3,2 programoje duomenų importo funkcija neaktyvuota, susisiekite su Pragma (Proringo) personalu, kad jį aktyvuotų.
          </Typography>
        </Box>

        {/* Ką galima importuoti į Pragma 3,2? */}
        <Typography
          variant="h3"
          sx={{
        ...
        >
          Importavus duomenis prekių, paslaugų bei kontrahentų kortelės automatiškai susikurs Pragma 3,2 programoje.
        </Typography>

        {/* Papildomi laukai Pragma 3,2 */}
        <Box
          sx={{
            maxWidth: '900px',
            width: '100%',
        ...
        >
          ...
          <Box
            component="img"
            src="pragma_32_papildomi_laukai.jpg"
            alt="Pragma 3,2 papildomi laukai DokSkenas nustatymuose"
            loading="lazy"
            sx={{
              width: '100%',
              display: 'block',
      ...
      >
        ...
        >
          Šiame video parodome pilną procesą nuo sąskaitų įkėlimo skaitmenizuoti iki duomenų importo į Pragma 4.
        </Typography>
        {/* Placeholder для видео */}
        <Box
          sx={{
        ...
        >
          <CheckCircleOutlineIcon sx={{ color: '#2e7d32', fontSize: 28, flexShrink: 0, marginTop: '2px' }} />
          <Typography
            sx={{
              fontSize: '17px',
              fontFamily: 'Helvetica',
          ...
          >
            Jūsų Pragma 4 jau yra įdiegta duomenų importo funkcija. Nieko papildomai įsigyti ar įdiegti nereikės.
          </Typography>
        </Box>

        {/* Ką galima importuoti į Pragma 4? */}
        <Typography
          variant="h3"
          sx={{
            fontSize: { xs: '24px', sm: '28px' },
        ...
        >
          Importavus duomenis prekių, paslaugų bei kontrahentų kortelės automatiškai susikurs Pragma 4 programoje.
        </Typography>

        {/* Papildomi laukai Pragma 4 */}
        <Box
          sx={{
            maxWidth: '900px',
            width: '100%',
        ...
        >
          ...
          <Box
            component="img"
            src="pragma_4_papildomi_laukai.jpg"
            alt="Pragma 4 papildomi laukai DokSkenas nustatymuose"
            loading="lazy"
            sx={{
              width: '100%',
              display: 'block',
      ...
      >
        ...
        <Stack spacing={3} sx={{ maxWidth: '800px', width: '100%', padding: { xs: 1, sm: 0 } }}>
          {[
            ...
            { step: 4, bold: 'Eksportuokite į Pragma:', text: ' pasirinkite "Pragma 3,2" arba "Pragma 4" kaip savo apskaitos programą nustatymuose' },
            { step: 5, bold: 'Importuokite į Pragma:', text: ' atidarykite failą Pragma programoje ir patvirtinkite' },
          ].map((item, idx) => (
        ...
        >
          {[
            ...
            'Priskiria prekių/paslaugų kodus iš Pragma apskaitos programos',
      ...
      >
        ...
        >
          Automatinis prekių ir paslaugų kodų iš Pragma priskyrimas
        </Typography>
        <Typography
          variant="body1"
          sx={{
        ...
        >
          Šiame video parodome kaip nusistatyti, kad prekių ir paslaugų kodai iš Pragma automatiškai prisiskirtų jūsų dokumentams, pagal jūsų nustatytas sąlygas.
        </Typography>
