...
const Debetas = () => {
  ...
  return (
    <Box sx={{ bgcolor: '#F9F9FA', minHeight: '100vh', padding: { xs: 2, sm: 5 }, paddingTop: { xs: '50px', sm: '70px' }, width: '100%' }}>
      <Helmet>
        <title>Sąskaitų importas į Debetą</title>
        <meta name="description" content="Automatizuokite sąskaitų faktūrų įvedimą į Debeto buhalterinę programą. DokSkenas atpažįsta dokumentus ir eksportuoja .csv failą, paruoštą Debeto importui." />
      </Helmet>
      ...
      >
        ...
        >
          Automatizuokite sąskaitų faktūrų nuskaitymą ir įvedimą į Debeto buhalterinę programą bei išvenkite nuobodaus rankinio darbo ir klaidų apskaitoje.
        </Typography>
        <Typography
          variant="body1"
          sx={{
        ...
        >
          DokSkenas atpažįsta dokumentus ir paruošia .csv failus, paruoštus importui į Debetą.
        </Typography>
        <Button
          variant="contained"
          size="large"
      ...
      >
        ...
        >
          Importavus duomenis prekių, paslaugų bei kontrahentų kortelės automatiškai susikurs Debeto programoje.
        </Typography>
      </Box>
      ...
      >
        ...
        >
          Šiame video parodome pilną procesą nuo sąskaitų įkėlimo skaitmenizuoti iki duomenų importo į Debetą.
        </Typography>
        ...
        >
          ...
          >
            Duomenis į Debetą importuokite per{' '}
            <Box component="span" sx={{ fontWeight: 700 }}>
              „Centrinė darbo vieta -&gt; Duomenų perkėlimas iš „ASCII" formato 2 -&gt; Perkeltų duomenų tvarkymas"
            </Box>
            :
          </Typography>
        </Box>
        ...
        >
          ...
          >
            Jei jūsų Debeto programoje duomenų importo funkcija neaktyvuota, susisiekite su Debeto personalu, kad jį aktyvuotų.
          </Typography>
        </Box>
        ...
        <Stack spacing={3} sx={{ maxWidth: '800px', width: '100%', padding: { xs: 1, sm: 0 } }}>
          {[
            ...
            { step: 4, bold: 'Eksportuokite į Debetą:', text: ' pasirinkite "Debetas" kaip savo apskaitos programą nustatymuose' },
            { step: 5, bold: 'Importuokite į Debetą:', text: ' atidarykite failą Debeto programoje ir patvirtinkite' },
          ].map((item, idx) => (
