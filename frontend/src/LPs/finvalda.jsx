...
const Finvalda = () => {
  ...
  // Videos
  const VIDEO_URL = "https://www.youtube.com/embed/n1OGeQ9quEk";
  ...
  return (
    <Box sx={{ bgcolor: '#F9F9FA', minHeight: '100vh', padding: { xs: 2, sm: 5 }, paddingTop: { xs: '50px', sm: '70px' }, width: '100%' }}>
      <Helmet>
        <title>Sąskaitų importas į Finvaldą</title>
        <meta name="description" content="Automatizuokite sąskaitų faktūrų įvedimą į Finvalda buhalterinę programą. DokSkenas atpažįsta dokumentus ir eksportuoja .xml failą, paruoštą Finvalda importui." />
      </Helmet>
      ...
      >
        ...
        >
          Automatizuokite sąskaitų faktūrų nuskaitymą ir įvedimą į Finvalda buhalterinę programą bei išvenkite nuobodaus rankinio darbo ir klaidų apskaitoje.
        </Typography>
        <Typography
          variant="body1"
          sx={{
        ...
        >
          DokSkenas atpažįsta dokumentus ir paruošia .xml failus, paruoštus importui į Finvaldą.
        </Typography>
        <Button
          variant="contained"
          size="large"
      ...
      {/* Ką galite importuoti į Finvaldą? */}
      <Box
        sx={{
          width: '100%',
          display: 'flex',
      ...
      >
        ...
        >
          Importavus duomenis prekių, paslaugų bei kontrahentų kortelės automatiškai susikurs Finvalda programoje.
        </Typography>
      </Box>
      ...
      >
        ...
        >
          Šiame video parodome pilną procesą nuo sąskaitų įkėlimo skaitmenizuoti iki duomenų importo į Finvaldą.
        </Typography>
        ...
        >
          ...
          >
            Duomenis į Finvaldą importuokite per{' '}
            <Box component="span" sx={{ fontWeight: 700 }}>
              „Įrankiai -&gt; Duomenų importas"
            </Box>
            :
          </Typography>
          <Box
          ...
          >
            <Typography
              component="li"
              sx={{ fontSize: '18px', fontFamily: 'Helvetica', color: '#1b1b1b', marginBottom: 1.5, paddingLeft: 1 }}
            >
              Pridėkite varnelę prie{' '}
              <Box component="span" sx={{ fontWeight: 700 }}>„Užpildyti import varneles"</Box>
            </Typography>
            <Typography
              component="li"
              sx={{ fontSize: '18px', fontFamily: 'Helvetica', color: '#1b1b1b', marginBottom: 1.5, paddingLeft: 1 }}
            >
              Spauskite ant{' '}
              <Box component="span" sx={{ fontWeight: 700 }}>„Nustatymai"</Box>
              {' '}ir užpildykite numatytąsias parametrų reikšmes (kito importo metu parametrų pildyti nebereikės)
            </Typography>
            <Typography
              component="li"
              sx={{ fontSize: '18px', fontFamily: 'Helvetica', color: '#1b1b1b', marginBottom: 1.5, paddingLeft: 1 }}
            >
              Spauskite ant{' '}
              <Box component="span" sx={{ fontWeight: 700 }}>„Naršyti"</Box>
              {' '}ir pasirinkite failą parsisiųstą iš DokSkeno
            </Typography>
            <Typography
              component="li"
              sx={{ fontSize: '18px', fontFamily: 'Helvetica', color: '#1b1b1b', marginBottom: 0, paddingLeft: 1 }}
            >
              Tada spauskite ant{' '}
              <Box component="span" sx={{ fontWeight: 700 }}>„Importuoti"</Box>
              {' '}ir{' '}
              <Box component="span" sx={{ fontWeight: 700 }}>„Pirmyn"</Box>
            </Typography>
          </Box>
        </Box>
        ...
        >
          <WarningAmberIcon sx={{ color: '#f57c00', fontSize: 28, flexShrink: 0, marginTop: '2px' }} />
          <Typography
            sx={{
              fontSize: '17px',
              fontFamily: 'Helvetica',
          ...
          >
            Jei jūsų Finvalda programoje{' '}
            <Box component="span" sx={{ fontWeight: 700 }}>„Duomenų importas"</Box>
            {' '}neaktyvuotas, susisiekite su Finvalda personalu, kad jį aktyvuotų.
          </Typography>
        </Box>
        ...
        <Box
          component="img"
          src="finvalda_papildomi_laukai.jpg"
          alt="Finvalda papildomi laukai DokSkenas nustatymuose"
          sx={{
            width: '100%',
            maxWidth: '900px',
            borderRadius: 3,
        ...
        <Stack spacing={3} sx={{ maxWidth: '800px', width: '100%', padding: { xs: 1, sm: 0 } }}>
          {[
            ...
            { step: 4, bold: 'Eksportuokite į Finvaldą:', text: ' pasirinkite "Finvalda" kaip savo apskaitos programą nustatymuose' },
            { step: 5, bold: 'Importuokite į Finvaldą:', text: ' atidarykite failą Finvalda programoje ir patvirtinkite' },
          ].map((item, idx) => (
        ...
        >
          {[
            ...
            'Priskiria prekių/paslaugų kodus iš Finvalda apskaitos programos',
      ...
      >
        ...
        >
          Automatinis prekių ir paslaugų kodų iš Finvalda priskyrimas
        </Typography>
        <Typography
          variant="body1"
          sx={{
        ...
        >
          Šiame video parodome kaip nusistatyti, kad prekių ir paslaugų kodai iš Finvalda automatiškai prisiskirtų jūsų dokumentams, pagal jūsų nustatytas sąlygas.
        </Typography>
        {/* Embedded YouTube Video */}
        <Box
          sx={{
