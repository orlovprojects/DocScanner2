...
export default function UploadProgressDialog({
  ...
  // Когда finalizing — показываем 98%
  const displayPercent = phase === "finalizing" ? 98 : bytePercent;

  // DEBUG - убери после проверки
  console.log("[UploadProgress]", { bytes, totalBytes, bytePercent, displayPercent, phase });
              ...
              {phase === "finalizing" ? (
                ...
                <LinearProgress
                  ...
                  sx={{
                    ...
                    "& .MuiLinearProgress-bar": {
                      borderRadius: 999,
                      // Отключаем transition чтобы бар обновлялся мгновенно
                      transition: "none",
                    },
                  }}
                />
