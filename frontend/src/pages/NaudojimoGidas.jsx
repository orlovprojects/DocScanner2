...
export default function NaudojimoGidas() {
  ...
  return (
    <Box sx={{ minHeight: "100vh", backgroundColor: "#fafafa" }}>
      <Helmet>
        <title>Naudojimo gidas – DokSkenas</title>
        <meta
          name="description"
          content="Šiame gide rasite atsakymus į visus klausimus susijusius su DokSkeno naudojimu bei integracijomis su apskaitos programomis."
        />
      </Helmet>
